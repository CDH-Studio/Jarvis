...
Route.get('/:bookingType/:id/bookings', 'BookingController.getBookings').as('viewBookingz').middleware(['auth']);
Route.get('/:bookingType/:id/bookings/:catFilter/:limitFilter', 'BookingController.getUserBookingz').as('viewBookings').middleware(['auth']);
