...
Route.post('/issue/:id', 'IssueController.editIssue').as('editIssue').middleware(['auth']);
// user
...
Route.get('/user/:id/bookings', 'BookingController.viewUserBookings').as('viewBookings').middleware(['auth']);
